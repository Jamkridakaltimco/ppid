<template>
  ...
  <div class="flex justify-end md:ml-4 md:mt-0">
    ...
    <a :href="`#/pengaturan/buku/${props.buku}/edit`" class="ml-3 text-white bg-blue-700 hover:bg-white hover:text-blue-700 shadow-md group flex gap-x-3 rounded-md px-4 py-2 text-sm leading-6 font-semibold">
