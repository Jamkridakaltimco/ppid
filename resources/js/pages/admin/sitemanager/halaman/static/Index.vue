  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-base text-xl font-bold leading-6 text-blue-800">Static</h1>
      </div>
      ...
      <a href="#/sitemanager/halaman/static/create" class="ml-3 text-white bg-blue-800 hover:bg-white hover:text-blue-700 shadow-md group flex gap-x-3 rounded-md px-4 py-2 text-sm leading-6 font-semibold">
        ...
        <tbody>
          <tr v-for="item in posts.data" :key="item.id" class="hover:bg-blue-100">
            ...
            <td class="whitespace-normal px-3 py-3 capitalize text-xs flex">
              <a :href="`#/sitemanager/halaman/static/${item.uuid}/detail`">
                <InformationCircleIcon class="h-5 w-5 text-gray-500" aria-hidden="true" />
              </a>
              <a :href="`#/sitemanager/halaman/static/${item.uuid}/edit`">
