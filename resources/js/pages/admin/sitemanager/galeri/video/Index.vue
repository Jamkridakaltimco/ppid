  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-base text-xl font-bold leading-6 text-blue-800">Video</h1>
      </div>
      ...
      <a href="#/sitemanager/galeri/video/create" class="ml-3 text-white bg-blue-800 hover:bg-white hover:text-blue-700 shadow-md group flex gap-x-3 rounded-md px-4 py-2 text-sm leading-6 font-semibold">
      ...
      <table class="min-w-full divide-y divide-gray-300">
        <thead class="bg-blue-800">
          <tr>
            ...
            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-100 lg:table-cell">Link</th>
        ...
        <tbody>
          <tr v-for="item, index in galleries.data" :key="item.id" class="hover:bg-blue-100">
            ...
            <td class="whitespace-normal px-3 py-3 capitalize text-xs">{{ item.link }}</td>
            <td class="whitespace-normal px-3 py-3 capitalize text-xs flex">
              <a :href="`#/sitemanager/galeri/video/${item.uuid}/detail`">
                <InformationCircleIcon class="h-5 w-5 text-gray-500" aria-hidden="true" />
              </a>
              <a :href="`#/sitemanager/galeri/video/${item.uuid}/edit`">
